...
class Article
{
    ...
    /**
     * For shorter SQL statements, we can use escape inputs, e. g. mysqli_escape_string($conn, $_POST['title']).
     * The $conn is needed, because this function takes into account the encoding of the database.
     */
